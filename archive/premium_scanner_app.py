...
app = Flask(__name__, template_folder='templates_premium')

# Store scan status and results
scan_status = {
    'triple_signal': {'running': False, 'last_run': None, 'results': ''},
    'backtest_triple': {'running': False, 'last_run': None, 'results': ''},
...
def parse_backtest_results(content):
    ...
    try:
        ...
        for line in lines:
            ...
            elif 'Average P&L:' in line and 'Average P&L ($)' not in line:
...
def run_script_background(script_name, scan_type):
    ...
    try:
        ...
        scan_status[scan_type]['results'] = f"Starting {scan_type}...\n"
...
def run_scan(scan_type):
    ...
    scripts = {
        ...
        'backtest_triple': 'watchlist_Scanner/BacktestTripleSignal.py',
...
def view_results(result_type):
    ...
    files = {
        'triple_signal': 'watchlist_Scanner/buylist/triple_signal_scan_results.txt',
        'backtest_triple': 'watchlist_Scanner/buylist/triple_signal_backtest_results.txt',
        'backtest_maroon': 'watchlist_Scanner/buylist/triple_signal_maroon_backtest_results.txt',
        'tradingview_triple': 'watchlist_Scanner/buylist/tradingview_triple_signal_list.txt'
    }
