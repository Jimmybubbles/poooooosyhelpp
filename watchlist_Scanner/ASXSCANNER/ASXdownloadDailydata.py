...
ticker_file_path = r"watchlist_Scanner\CSV\ASXListedCompanies.csv"

# Directory to save CSV files
output_dir = r"watchlist_Scanner\ASXSCANNER\Download_Results"
...
for ticker_symbol in tickers:
    try:
        ...
        stock_data = yf.download(ticker_symbol + '.AX', start=start_date, end=end_date, interval="1d", auto_adjust=True)
