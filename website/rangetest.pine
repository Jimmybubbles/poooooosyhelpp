...
// © Zeiierman {
//@version=6
indicator('Range Oscillator (Zeiierman) jimmy adjusted', overlay = false, precision = 1)
//~~}
...
// ~~ Inputs {
length = input.int(26, minval = 1, step = 1, title = 'Minimum Range Length', tooltip = t1, group = 'Range Oscillator')
mult   = input.float(5, minval = 0.1, step = 0.1, title = 'Range Width Multiplier', tooltip = t2, group = 'Range Oscillator')
